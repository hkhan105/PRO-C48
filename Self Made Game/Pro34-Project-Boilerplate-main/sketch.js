...
function setup() 
{
  ...
  helicopter = createImg('helicopterAnimation/helicopter.gif');
  helicopter.position(20,30);
  helicopter.size(500,200);
 
  helicopter2 = createImg('helicopterAnimation/helicopter.gif');
  helicopter2.position(330,35);
  helicopter2.size(500,200); 
   

  helicopter3 = createImg('helicopterAnimation/helicopter.gif');
  helicopter3.position(360,200);
  helicopter3.size(500,200);
